...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::factory()->create(['id_number' => 11111,'name'=>'ADMIN'])->each(function($user)  use($roleForAdmin){
            $user->roles()->attach($roleForAdmin->id);
        });

        User::factory()->create(['id_number' => 22222,'name'=>'STUFF'])->each(function($user)  use($roleForStaff){
